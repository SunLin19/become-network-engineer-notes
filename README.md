...
* [ ] 周三-周日（三层交换机与路由器）7.30-8.4
  * **通俗通俗能懂的去解释尽量不涉及IP、子网掩码、网关**
...
* 简单网络设备概览
  ...
  * [三层交换机与路由器](mach/三层交换机与路由器.md)（如何避免或者说尽量通俗化？）
...
发展史：了解历史可以知道他们出于什么目的而设计或开发某一功能模块的（为什么要这样设计）

网络设备：了解网络设备**基本用途（目的）**，对以后理解OSI模型应该不是那么抽象
