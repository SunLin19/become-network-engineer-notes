...
> 网络地址是识别网络ID用的 ，如192.168.1.0 ，说明该网段属于192.168.1的段 ，属于不可用IP；广播地址是用来进行广播的 ，如ARP广播，192.168.1.255地址是一个通用地址，这些机器在询问网关的时候把信息发往192.168.1.255，192.168.1.1-192.168.1.254 的所有机器都可以接收到它发来的信息，信息会问谁是网关你的MAC地址是多少，如果有一台机器是网关他就会回应 。
