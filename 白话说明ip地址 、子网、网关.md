...
将上表的二进制分别转化为十进制即为A类地址使用范围：1 ~ 127

十进制表示范围：1.0.0.1-127.255.255.255,任何一个0到127间的网络地址均是一个A类地址。

可用范围：

A类地址具有7位网络编号，但网络编号不能是全0或全1，因此可定义126（127-1）个A类网络

每个网络可以拥有的主机数为2<sup>3*8</sup>-2=16777214
...
将上表的二进制分别转化为十进制即为A类地址使用范围：128 ~ 191

十进制表示范围：128.0.0.1-191.255.255.255,任何一个128到191间的网络地址是一个B类地址。

可用范围：

B类地址具有14位网络编号，因此可定义2^14-2（16382）个B类网络，每个网络可以拥有的主机数为2^16-2（65534）
...
|||
|:-:|:-:|
|11 00 0000|11 01 1111|
|192|223|

表示范围：192~223

将上表的二进制分别转化为十进制即为A类地址使用范围：1 ~ 191

十进制表示范围：192.0.0.1-223.255.255.255,任何一个192到223间的网络地址是一个C类地址。

可用范围：

C类地址具有21位网络编号，因此可定义2^21-2（2097152）个C类地址，每个网络可以拥有的主机数为2^8-2（254）
---
